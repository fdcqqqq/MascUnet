...
class Prediction(object):
    ...
    def evaluate_segmented_volume(self, filepath_image, save, show, save_path):
        ...
        if save:
            ...
            sitk.WriteImage(tmp, './prediction/{}.nii.gz'.format(save_path))
        ...
        return np.array((Dice_complete, Dice_core, Dice_enhancing, Sensitivity_whole,
                         Sensitivity_core, Sensitivity_en, Specificity_whole, Specificity_core, Specificity_en,
                         Hausdorff_whole, Hausdorff_core, Hausdorff_en))  # ))
